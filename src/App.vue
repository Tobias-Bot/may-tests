<template>
  <v-app>
    <v-app-bar app :height="this.toolbarHeight" color="#F6E2ED" elevation="0">
      <v-toolbar-title>
        <a href="https://vk.com/warmay" hidden ref="linkRef"></a
        ><span class="logoTitle" @click="goToMay">Мαú</span
        ><span class="appTitle">тесты</span></v-toolbar-title
      >
    </v-app-bar>
      ...
      <v-container fluid>
        <v-dialog v-model="dialogSwitch" scrollable>
          <v-card color="#F6E2ED">
            ...
            <v-card-actions>
              ...
              <v-btn color="##688AED" text @click="subscribeOnGroup">
                Подписаться
              </v-btn>
            </v-card-actions>
          </v-card>
        ...
        <v-dialog v-model="dialogNotifySwitch" scrollable persistent>
          <v-card color="#F6E2ED">
            ...
            <v-divider></v-divider>
            <v-card-actions>
              <v-btn color="#688AED" text @click="getUserData">
                Разрешить
              </v-btn>
            </v-card-actions>
          </v-card>
    ...
    >
      ...
      >
        <v-tab>
          <div class="tagTitle">Тесты</div>
          <v-icon>mdi-list-status</v-icon>
        </v-tab>
        <v-tab>
          <div class="tagTitle">Профиль</div>
